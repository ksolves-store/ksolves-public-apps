//pk.eyJ1IjoiZGV2dnZ2dnZ2diIsImEiOiJja3Nvb2Z1cHkwNnhxMnNzNmNsNTAxZ2d2In0.2LMgt_oPT8XSFQ6IlEjLkw
odoo.define('Ks_Map.map', function (require) {
    ...
    ajax.jsonRpc("/ks_get_map_cod", 'call', {}, {
        ...
        if(Object.keys(cod).length) {
            ...
            L.tileLayer('https://api.mapbox.com/styles/v1/{id}/tiles/{z}/{x}/{y}?access_token='+cod.token,
            {
